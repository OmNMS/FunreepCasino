...
namespace AndarBahar.Gameplay
{
    class AndarBahar_OnlinePlayerBot : MonoBehaviour
    {
        ...
        private void Start()
        {
           ...
           // Debug.Log("datano: " + dataNo);
            Debug.Log("chipdata count: " + chipData.Count);
        ...
        IEnumerator CreateChip(float delay, int index)
        {
            ...
            try
            {
                ...
                if (chipMovement != null)
                    chipMovement.CreateChip(O.position, ABUI.currentChip, O.spot, botNo);
