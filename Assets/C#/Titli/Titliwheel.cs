...
public class Titliwheel : MonoBehaviour
{
    ...
    public static Titliwheel instane;
    ...
    //[SerializeField] Titli_RoundWinningHandler roundwin;
    ...
    //     {37, 9.47f * 19 },
    // };
    private float[] Pose = {5,6,11,2,3,7,1,4,0,12,10,9,8};//{5,22,34,15,3,24,36,13,1,37,27,10,25,29,12,8,19,31,18,6,21,33,16,4,23,35,14,2,0,28,9,26,30,11,7,20,32,17}; 
    float lastpose = 0;
    float seventwenty;
    ...
    void AfterSpin(int wheelNo)
    {
        ...
        Titli_RoundWinningHandler.Instance.SpinComplete();
        RemoveParents();
