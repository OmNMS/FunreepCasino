...
namespace FunTarget.ServerStuff
{
    ...
    public class FunTarget_ServerRequest : FunTarget_SocketHandler
    {
        //public SocketIOComponent socket;
        public static FunTarget_ServerRequest instance;
        ...
        // public void SendEvent(string eventName, object data, Action<string> json, string resposeEvent = null)//this one
        // {
        ...
        /// <param name="eventName"></param>
        /// <param name="json"></param>
        // public void SendEvent(string eventName, Action<string> json)//thisone
        // {
        //     if (isApplicationPaused) return;
        ...
        /// </summary>
        /// <param name="eventName"></param>
        // public void SendEvent(string eventName)//this one
        // {
        //     //if (isApplicationPaused) return;
